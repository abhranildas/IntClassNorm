...
# Images are embedded via absolute raw.githubusercontent.com URLs, since a
# repo-relative path wouldn't resolve on renderers with no base URL to
# resolve against (e.g. a File Exchange-synced description).
RAW_BASE = "https://raw.githubusercontent.com/abhranildas/IntClassNorm/main"
...
# covers it) / h2 / h3 / h4; demoted by one level to sit under README's own
# "## Examples" heading.
HEADING_MARKDOWN = {"h2": "###", "h3": "####", "h4": "#####"}
...
def slugify(text: str, max_len: int = 50) -> str:
    """Slugify, truncating at a word boundary so image filenames/paths stay
    short -- some of this guide's headings are full sentences."""
...
def update_readme(examples_markdown: str) -> None:
    ...
    if pattern.search(readme):
        ...
        anchor = "The following are the worked examples from that guide:\n"
